...
export default function AdminBibliothequePage() {
    ...
    const handleImageUpload = async (file: File) => {
        ...
        try {
            console.log('📤 Début de l\'upload:', file.name, file.size, file.type)
            ...
            addToast({
                type: 'error',
                title: 'Erreur',
                message: `Impossible d'uploader l'image: ${errorMessage}`
            })
        } finally {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.ok) {
                addToast({
                    type: 'success',
                    title: editingBook ? 'Livre modifié' : 'Livre ajouté',
                    message: `Le livre "${formData.title}" a été ${editingBook ? 'modifié' : 'ajouté'} avec succès`
                })
                fetchBooks()
                resetForm()
            ...
            addToast({
                type: 'error',
                title: 'Erreur',
                message: 'Impossible de sauvegarder le livre'
            })
        }
    }
                            ...
                            <div className="p-6">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <label
                                                ...
                                                className="flex items-center px-3 py-2 border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer text-sm"
                                            >
                                    ...
                                    <div className="flex justify-end space-x-3 pt-3">
                                        ...
                                        <button
                                            type="submit"
                                            className="px-4 py-2 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-colors flex items-center text-sm"
                                        >
